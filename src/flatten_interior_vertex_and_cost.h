...
/*
flattening an interior vertex and compute the flattening cost. The difference with the above function is that all the intrinsic information will get updated in place
