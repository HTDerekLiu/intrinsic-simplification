...
// This is a helper function for "flatten_boundary_vertex_and_cost.h", which flatten an boundary vertex. If you want to use it for other functions, please use it with causion
