...
/*
Performs an intrinsic edge flip on the edge given by face-side (f, s). This edge flip rotate the (f,s) counter clockwise.
...
Outputs 
    everything update in place besides s0
